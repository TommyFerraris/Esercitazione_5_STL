...
struct PolygonalMesh
{
    ...
    std::vector<vector<unsigned int>> Cell2DVertices = {}; ///< Cell2D Vertices indices, size variable x NumberCell2DVertices[NumberCell2D]
    std::vector<unsigned int> Cell2DNumEdges = {}; ///< Cell2D number of vertices, size 1 x NumberCell2D
    std::vector<vector<unsigned int>> Cell2DEdges = {}; ///< Cell2D Cell1D indices, size variable x NumberCell2DEdges[NumberCell2D]
